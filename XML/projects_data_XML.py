...
xml = dicttoxml(new_list, custom_root='Projects', attr_type=False) # convert list to xml data

print(xml.decode("UTF-8"))

#with open("Projects.xml", "w") as f: # store xml data into a file
